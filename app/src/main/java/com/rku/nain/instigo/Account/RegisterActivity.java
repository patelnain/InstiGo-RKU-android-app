...
import com.rku.nain.instigo.User.UserClass;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public boolean validateUserInput(String signUpEmail,String signUpUsername,String signUpPass){
        ...
        if(!domain.equalsIgnoreCase("rku.ac.in"))
        {

            Toast.makeText(RegisterActivity.this, "Register only with RKU account", Toast.LENGTH_SHORT).show();
            loginHere.setFocusable(true);
            loginHere.setClickable(true);
            return false;
        }
